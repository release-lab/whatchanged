...
curl -fsSL https://raw.githubusercontent.com/axetroy/whatchanged/master/install.sh | bash -s v0.2.6
# or install from gobinaries.com
curl -sf https://gobinaries.com/axetroy/whatchanged@v0.2.6 | sh
```
